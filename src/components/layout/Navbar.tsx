          ...
          <div className="site-nav__actions">
            ...
            <MobileMenu>
              <div className="flex flex-col gap-1">
                <Link className="site-nav__link" href="/" onClick={() => {}}>
                  {t("catalogTitle")}
                </Link>
                <Link className="site-nav__link" href="/docs">Api</Link>
                <Link className="site-nav__link" href="/data-model">Data Model</Link>
                {isAdmin && <AdminMenu />}
                <Link className="site-nav__cta mt-2" href="/editor">Editor</Link>
              </div>
            </MobileMenu>
          </div>
        </div>
