          ...
          <div className="grid grid-cols-2 gap-x-6 gap-y-5">
            {availability ? (
              <div className="sm:col-span-2">
                ...
                <dd className="mt-1.5 flex items-center gap-2 text-sm font-semibold text-gray-900">
                  {availability}%
            ...
            {readyBy ? (
              <div>
                <div className="flex items-center gap-1.5">
                  ...
                  <dt className="text-xs font-semibold text-gray-500">{t("sectionSlaFreshness")}</dt>
                </div>
                <dd className="mt-1.5 text-sm font-semibold text-gray-900">{tWith("sectionSlaReadyBy", { readyBy })}</dd>
              </div>
            ) : null}
            ...
            {frequency ? (
              <div>
                <div className="flex items-center gap-1.5">
                  ...
                  <dt className="text-xs font-semibold text-gray-500">{t("sectionSlaFrequency")}</dt>
                </div>
                <dd className="mt-1.5 text-sm font-semibold text-gray-900">{frequency}</dd>
              </div>
            ) : null}
            ...
            {maxDelayMinutes ? (
              <div>
                <div className="flex items-center gap-1.5">
                  ...
                  <dt className="text-xs font-semibold text-gray-500">{t("sectionSlaMaxDelay")}</dt>
                </div>
                <dd className="mt-1.5 text-sm font-semibold text-gray-900">{maxDelayMinutes} minutes</dd>
              </div>
            ) : null}
          </div>
        </div>
