              ...
              <article className="contract-summary-strip__card">
                <div className="flex items-center justify-between gap-1.5">
                  <div className="flex items-center gap-1.5">
                    <svg className="h-3.5 w-3.5 shrink-0 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  ...
                  <strong className="m-0 text-sm font-bold text-indigo-600">{fields}</strong>
                </div>
              </article>
              <article className="contract-summary-strip__card">
                <div className="flex items-center justify-between gap-1.5">
                  <div className="flex items-center gap-1.5">
                    <svg className="h-3.5 w-3.5 shrink-0 text-teal-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  ...
                  <strong className="m-0 text-sm font-bold text-teal-600">{sources}</strong>
                </div>
              </article>
              <article className="contract-summary-strip__card">
                <div className="flex items-center justify-between gap-1.5">
                  ...
                  <strong className="m-0 text-sm font-bold text-green-600">{qualityChecks}</strong>
                </div>
              </article>
              <article className="contract-summary-strip__card">
                <div className="flex items-center justify-between gap-1.5">
                  <div className="flex items-center gap-1.5">
                    <svg className="h-3.5 w-3.5 shrink-0 text-orange-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 13.803-3.7M4.031 9.865a8.25 8.25 0 0 1 13.803-3.7l3.181 3.182" />
                    </svg>
                    <span className="contract-summary-strip__label">{t("lifecycle")}</span>
                  </div>
                  <strong className="m-0 text-sm font-bold text-orange-600">{asset.status ?? t("draft")}</strong>
                </div>
              </article>
            </section>
