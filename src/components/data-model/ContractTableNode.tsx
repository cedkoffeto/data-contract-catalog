  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className={`ml-auto rounded border px-1.5 py-0.5 text-[10px] font-medium uppercase leading-none ${maturityBadge[d.maturity as string] || maturityBadge.bronze}`}>
      ...
      <div className="divide-y divide-gray-100">
        {(d.fields as { name: string; type: string }[]).map((f) => (
